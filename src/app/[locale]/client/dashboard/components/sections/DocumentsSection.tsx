                          ...
                          <>
                            ...
                            <div className='rounded-lg border border-gray-200 bg-gray-50 p-4 text-sm text-gray-700'>
                              ...
                              <dl className='grid grid-cols-1 gap-3 sm:grid-cols-2'>
                                {request.request_kind === 'reference' && Array.isArray(latestSubmission.form_data?.references) ? (
                                  <div className='col-span-full space-y-3'>
                                    <p className='text-xs font-semibold uppercase tracking-wide text-gray-500'>
                                      {t('References') || 'References'}
                                    </p>
                                    <div className='grid grid-cols-1 gap-3 sm:grid-cols-2'>
                                      {latestSubmission.form_data.references.map((ref: any, idx: number) => (
                                        <div key={idx} className='rounded bg-white p-3 shadow-sm'>
                                          ...
                                          <dl className='mt-2 space-y-1 text-sm text-gray-700'>
                                            ...
                                            <div>
                                              ...
                                              <span className='block text-gray-900'>{ref?.phone || '—'}</span>
                                            </div>
                                            <div>
                                              <span className='block text-xs font-medium uppercase tracking-wide text-gray-500'>
                                                {t('Relationship') || 'Relationship'}
                                              </span>
                                              <span className='block text-gray-900 capitalize'>{ref?.relationship || '—'}</span>
                                            </div>
                                            {ref?.notes && (
                                              <div>
                                                <span className='block text-xs font-medium uppercase tracking-wide text-gray-500'>
                                                ...
                                                <span className='block text-gray-900'>{ref.notes}</span>
                                              </div>
                                            )}
                                          </dl>
                                        </div>
