-- Drop and recreate the function with Flinks parameters
...
BEGIN
  ...
  -- Step 3: Create or update address
  ...
  ON CONFLICT (client_id, street_number, street_name, city) DO UPDATE SET
  ...
  -- Step 4: Update user's current address
  UPDATE public.users
  SET current_address_id = v_address_id
  WHERE id = v_client_id;
  
  -- Step 5: Create loan application with Flinks data
